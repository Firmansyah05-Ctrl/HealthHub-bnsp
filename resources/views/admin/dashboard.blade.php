...
@section('title', 'Admin Dashboard - HealthHub')
@section('description', 'Panel admin untuk mengelola produk, pesanan, dan pengguna di HealthHub.')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['total_orders'] }}</p>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($statistics['total_revenue'], 0, ',', '.') }}</p>
                    ...
                    <div class="relative p-8">
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">{{ $statistics['total_products'] }}</div>
                   ...
                   class="admin-card group relative bg-gradient-to-br from-white via-blue-50 to-indigo-50 rounded-3xl shadow-xl hover:shadow-2xl border border-blue-100 overflow-hidden transform hover:-translate-y-4 transition-all duration-500">
                    ...
                    <div class="relative p-8">
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{{ $statistics['total_stock'] }}</div>
                   ...
                   class="admin-card group relative bg-gradient-to-br from-white via-emerald-50 to-green-50 rounded-3xl shadow-xl hover:shadow-2xl border border-emerald-100 overflow-hidden transform hover:-translate-y-4 transition-all duration-500">
                    ...
                    <div class="relative p-8">
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">{{ $statistics['total_categories'] }}</div>
                   ...
                   class="admin-card group relative bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-3xl shadow-xl hover:shadow-2xl border border-purple-100 overflow-hidden transform hover:-translate-y-4 transition-all duration-500">
                    ...
                    <div class="relative p-8">
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">{{ $statistics['total_users'] }}</div>
                   ...
                   class="admin-card group relative bg-gradient-to-br from-white via-indigo-50 to-blue-50 rounded-3xl shadow-xl hover:shadow-2xl border border-indigo-100 overflow-hidden transform hover:-translate-y-4 transition-all duration-500">
                    ...
                    <div class="relative p-8">
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">{{ $statistics['total_orders'] }}</div>
                   ...
                   class="admin-card group relative bg-gradient-to-br from-white via-amber-50 to-orange-50 rounded-3xl shadow-xl hover:shadow-2xl border border-amber-100 overflow-hidden transform hover:-translate-y-4 transition-all duration-500">
                    ...
                    <div class="relative p-8">
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">{{ $statistics['total_feedback'] }}</div>
                       ...
                       class="admin-card group relative bg-gradient-to-br from-white via-rose-50 to-pink-50 rounded-3xl shadow-xl hover:shadow-2xl border border-rose-100 overflow-hidden transform hover:-translate-y-4 transition-all duration-500 block">
                        ...
                        <div class="relative p-8">
                            <div class="flex items-start justify-between mb-6">
                                ...
                                <div class="text-right">
                                    <div class="text-3xl font-bold bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent">{{ $statistics['total_shop_requests'] }}</div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.orders.index') }}" class="text-teal-600 hover:text-teal-700 font-medium text-sm">
                    Lihat Semua
        ...
        @if($statistics['recent_orders']->count() > 0)
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="w-10 h-10 bg-teal-100 rounded-full flex items-center justify-center">
                                    <span class="text-teal-600 font-semibold text-sm">#{{ $order->id }}</span>
                                </div>
                                <div>
                                    <p class="font-medium text-gray-900">{{ $order->user->name ?? 'User tidak ditemukan' }}</p>
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-sm text-gray-500">{{ $order->orderItems->sum('quantity') }} item</p>
                            </div>
                        </div>
                    </div>
                @endforeach
