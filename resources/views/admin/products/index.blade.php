...
@section('title', 'Kelola Produk - Admin HealthHub')
@section('description', 'Kelola semua produk alat kesehatan di HealthHub dengan interface modern.')
                                            ...
                                            <div class="flex items-start space-x-4">
                                                ...
                                                <div class="flex-grow min-w-0 space-y-4">
                                                    ...
                                                    <div class="space-y-2">
                                                        ...
                                                        {{-- <div class="inline-flex items-center space-x-2 text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-md">
                                                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                                                            </svg>
                                                            <span class="font-medium">ID: #{{ $product->id }}</span>
                                                        </div> --}}
                                                    </div>
                                            ...
                                            @if($product->category)
                                                <div class="space-y-3">
                                                    ...
                                                    <div class="flex items-center bg-gray-50 px-3 py-2 rounded-lg">
                                                        ...
                                                        @endif
                                                        <span class="ml-2 text-gray-600 font-bold text-xs">({{ $product->stock }})</span>
                                                    </div>
                                                </div>
                                            @else
                                                <div class="space-y-3">
