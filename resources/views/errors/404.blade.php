...
@section('title', 'Page Not Found - HealthHub')
    ...
    <div class="max-w-md mx-auto text-center">
        ...
        <div class="space-y-4">
            ...
            <div class="flex justify-center space-x-4 text-sm">
                <a href="{{ route('products.index') }}" class="text-blue-600 hover:text-blue-800 transition-colors duration-200">
                    Browse Products
                </a>
                <span class="text-gray-400">•</span>
                <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800 transition-colors duration-200">
                    Login
                </a>
                <span class="text-gray-400">•</span>
