...
<?php $__env->startSection('title', 'Kelola Pesanan - Admin HealthHub'); ?>
<?php $__env->startSection('description', 'Kelola dan monitor pesanan pelanggan di HealthHub.'); ?>
...
<div class="max-w-7xl mx-auto">
            ...
            <div class="hidden md:block">
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center">
                        <div class="text-2xl font-bold"><?php echo e($statistics['total_orders']); ?></div>
                        <div class="text-indigo-200 text-sm">Total Pesanan</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold">Rp <?php echo e(number_format($statistics['total_revenue'], 0, ',', '.')); ?></div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-gradient-to-br from-yellow-50 to-amber-100 rounded-2xl p-6 border border-yellow-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-yellow-700"><?php echo e($statistics['pending_orders']); ?></div>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-6 border border-blue-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-blue-700"><?php echo e($statistics['shipped_orders']); ?></div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-6 border border-green-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-green-700"><?php echo e($statistics['delivered_orders']); ?></div>
        ...
        <div class="bg-gradient-to-br from-red-50 to-rose-100 rounded-2xl p-6 border border-red-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-red-700"><?php echo e($statistics['cancelled_orders']); ?></div>
    ...
    <div class="filter-card bg-white rounded-2xl shadow-lg p-6 mb-8">
        <form method="GET" action="<?php echo e(route('admin.orders.index')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <!-- Search -->
            ...
            <div>
                <select name="payment_method" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <option value="postpaid" <?php echo e(request('payment_method') == 'postpaid' ? 'selected' : ''); ?>>Postpaid</option>
                    <option value="prepaid" <?php echo e(request('payment_method') == 'prepaid' ? 'selected' : ''); ?>>Prepaid</option>
                </select>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <?php if($orders->count() > 0): ?>
                            ...
                            <tr class="hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 transition-all duration-300 border-b border-gray-100 hover:shadow-md hover:border-teal-200">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <!-- Customer Info -->
                                        <div>
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($order->user->name ?? 'User tidak ditemukan'); ?></div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="space-y-2 max-w-sm">
                                            ...
                                            <div class="product-item-card primary-product flex items-center space-x-3 rounded-xl p-3 shadow-sm">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="text-xs font-medium text-teal-700">
                                                        Rp <?php echo e(number_format($item->price_per_item, 0, ',', '.')); ?>
                                        ...
                                        <?php if($order->orderItems->count() > 3): ?>
                                            <div id="order-products-<?php echo e($order->id); ?>" 
                                                 class="hidden space-y-2"
                                                 style="display: none;">
                                                <?php $__currentLoopData = $order->orderItems->skip(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="mt-4 pt-3 products-summary rounded-lg p-3">
                                            <div class="flex items-center justify-between">
                                                <div class="text-xs text-gray-600">
                                                    <div class="font-semibold"><?php echo e($order->orderItems->count()); ?> jenis produk</div>
                                                    <div class="text-gray-500"><?php echo e($order->orderItems->sum('quantity')); ?> total item</div>
                                                </div>
                                                ...
                                                <?php if($order->orderItems->count() > 3): ?>
                                                    <button type="button" 
                                                        ...
                                                        <span>Lihat <?php echo e($order->orderItems->count() - 3); ?> produk lainnya</span>
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.orders.update', $order)); ?>" class="flex items-center space-x-3">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="px-6 py-4 border-t border-gray-200">
                <?php echo e($orders->withQueryString()->links('custom-pagination')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DOKUMEN\BNSP\example-app\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>