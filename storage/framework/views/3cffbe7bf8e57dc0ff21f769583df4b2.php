...
<?php $__env->startSection('title', 'Dashboard - HealthHub'); ?>
<?php $__env->startSection('description', 'Kelola pesanan, profil, dan pengaturan akun Anda di HealthHub.'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($validOrders->count()); ?></p>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($completedOrders->count()); ?></p>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">Rp <?php echo e(number_format($totalSpent, 0, ',', '.')); ?></p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <a href="<?php echo e(route('products.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 p-6 text-center group">
        ...
        <a href="<?php echo e(route('cart.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 p-6 text-center group">
            <div class="w-12 h-12 bg-teal-100 rounded-lg flex items-center justify-center mx-auto mb-3 group-hover:bg-teal-200 transition-colors duration-200">
        ...
        <a href="<?php echo e(route('profile.edit')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 p-6 text-center group">
        ...
        <a href="<?php echo e(route('shop-requests.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 p-6 text-center group">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($order->created_at->setTimezone('Asia/Jakarta')->format('d M Y')); ?></div>
                                <div class="text-sm text-gray-500"><?php echo e($order->created_at->setTimezone('Asia/Jakarta')->format('H:i')); ?> WIB</div>
                            </td>
                            <td class="px-6 py-4">
                                    ...
                                    <?php if($order->orderItems->count() > 0): ?>
                                            ...
                                            <?php $__currentLoopData = $order->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex items-start py-1.5 px-2 bg-gray-50 rounded-lg order-item-card">
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <span class="font-medium text-gray-800 text-sm leading-tight block truncate" title="<?php echo e($item->product ? $item->product->name : ($item->product_name ?? 'Produk tidak ditemukan')); ?>">
                                                            <?php echo e($item->product ? $item->product->name : ($item->product_name ?? 'Produk tidak ditemukan')); ?>

                                                        </span>
                                                        <?php if($item->product && $item->product->price): ?>
                                                            <span class="text-xs text-gray-500 block mt-0.5">
                                                                Rp <?php echo e(number_format($item->price_per_item ?? $item->product->price, 0, ',', '.')); ?>
                                        ...
                                        <div class="flex justify-between items-center mt-3 pt-2 border-t border-gray-200">
                                            <span class="text-xs text-gray-500 font-medium">
                                                <?php echo e($order->orderItems->count()); ?> jenis produk
                                            </span>
                                            <span class="text-xs text-teal-600 font-semibold">
                                                <?php echo e($order->orderItems->sum('quantity')); ?> total item
                                            </span>
                                        </div>
                                    <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                ?>
                                <span class="inline-flex px-3 py-1 rounded-full text-xs font-semibold <?php echo e($statusClasses[$order->status] ?? 'bg-gray-100 text-gray-800'); ?>">
                                    <?php echo e($statusTranslations[$order->status] ?? $order->status); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <?php if($order->canReceiveFeedback()): ?>
                                        <a href="<?php echo e(route('feedback.create', $order)); ?>" 
                                    ...
                                    <?php elseif($order->hasFeedback()): ?>
                                        <a href="<?php echo e(route('feedback.show', $order)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('report.invoice', $order)); ?>" 
                                       class="inline-flex items-center px-3 py-1 text-xs font-medium text-green-600 bg-green-100 rounded-lg hover:bg-green-200 transition-colors duration-200">
                                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DOKUMEN\BNSP\example-app\resources\views/dashboard.blade.php ENDPATH**/ ?>