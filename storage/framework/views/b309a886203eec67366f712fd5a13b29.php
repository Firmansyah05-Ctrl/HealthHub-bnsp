...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'HealthHub - Perlengkapan Medis Profesional'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Perlengkapan medis premium dan perlengkapan untuk tenaga kesehatan profesional. Produk berkualitas dengan pengiriman cepat.'); ?>">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        <!-- Cart -->
                        <a href="<?php echo e(route('cart.index')); ?>" class="relative p-2 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-all duration-200 group">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center space-x-2 p-2 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50">
                                ...
                                <span class="font-medium hidden sm:block"><?php echo e(Auth::user()->name); ?></span>
                            ...
                            >
                                ...
                                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-4 py-3 text-sm hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                ...
                                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-3 text-sm hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php if(Auth::user()->role === 'admin'): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-4 py-3 text-sm hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 text-gray-600 hover:text-teal-600 font-medium transition-colors duration-200">Masuk</a>
                        <a href="<?php echo e(route('register')); ?>" class="px-6 py-2 bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-semibold rounded-lg hover:from-teal-700 hover:to-cyan-700 transform hover:-translate-y-0.5 transition-all duration-200 shadow-lg hover:shadow-xl">Daftar</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="md:hidden" x-data="{ mobileMenuOpen: false }">
                    ...
                    <div x-show="mobileMenuOpen" 
                        ...
                        <div class="py-2">
                            <a href="<?php echo e(route('products.index')); ?>" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('dashboard')); ?>" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                                        </svg>
                                ...
                                <a href="<?php echo e(route('cart.index')); ?>" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                ...
                                <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                        </svg>
                                ...
                                <?php if(Auth::user()->role === 'admin'): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                        <div class="flex items-center">
                                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                            </svg>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('register')); ?>" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-colors duration-200">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="container mx-auto px-4 py-16 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="<?php echo e(route('products.index')); ?>" class="flex items-center text-gray-300 hover:text-teal-400 transition-all duration-300 group">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <li>
                                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center text-gray-300 hover:text-teal-400 transition-all duration-300 group">
                                    <svg class="w-4 h-4 mr-3 text-teal-400 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                                    </svg>
                                    Dashboard Saya
                            ...
                            <li>
                                <a href="<?php echo e(route('cart.index')); ?>" class="flex items-center text-gray-300 hover:text-teal-400 transition-all duration-300 group">
                                    <svg class="w-4 h-4 mr-3 text-teal-400 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                                    </svg>
                                    Keranjang Belanja
                            ...
                            <li>
                                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center text-gray-300 hover:text-teal-400 transition-all duration-300 group">
                                    <svg class="w-4 h-4 mr-3 text-teal-400 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                    </svg>
                                    Profil Saya
                        ...
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e(route('register')); ?>" class="flex items-center text-gray-300 hover:text-teal-400 transition-all duration-300 group">
                                    <svg class="w-4 h-4 mr-3 text-teal-400 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                                    </svg>
                                    Daftar Akun
                            ...
                            <li>
                                <a href="<?php echo e(route('login')); ?>" class="flex items-center text-gray-300 hover:text-teal-400 transition-all duration-300 group">
                                    <svg class="w-4 h-4 mr-3 text-teal-400 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-gradient-to-r from-transparent via-gray-700 to-transparent pt-8">
                <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                    <div class="flex items-center space-x-2">
                        <p class="text-gray-400">&copy; <?php echo e(date('Y')); ?> HealthHub.</p>
...
<?php /**PATH D:\DOKUMEN\BNSP\example-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>