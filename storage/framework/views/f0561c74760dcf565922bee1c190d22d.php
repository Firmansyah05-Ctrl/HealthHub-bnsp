...
<?php $__env->startSection('title', 'Kelola Stok Produk - Admin HealthHub'); ?>
<?php $__env->startSection('description', 'Kelola dan monitor stok produk medis di HealthHub.'); ?>
...
<div class="max-w-7xl mx-auto">
            ...
            <div class="hidden md:block">
                <div class="flex items-center space-x-4">
                    <div class="text-center">
                        <div class="text-2xl font-bold"><?php echo e(App\Models\Product::sum('stock')); ?></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="stock-card bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-6 border border-green-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-green-700"><?php echo e($stockSummary['in_stock']); ?></div>
        ...
        <div class="stock-card bg-gradient-to-br from-orange-50 to-amber-100 rounded-2xl p-6 border border-orange-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-orange-700"><?php echo e($stockSummary['low_stock']); ?></div>
        ...
        <div class="stock-card bg-gradient-to-br from-red-50 to-rose-100 rounded-2xl p-6 border border-red-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-red-700"><?php echo e($stockSummary['out_of_stock']); ?></div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            ...
            <div class="flex-1 lg:mr-6">
                <form method="GET" action="<?php echo e(route('admin.products.stock')); ?>" class="flex items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-2xl font-bold text-green-600"><?php echo e($stockSummary['in_stock']); ?></div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-2xl font-bold text-yellow-600"><?php echo e($stockSummary['low_stock']); ?></div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-2xl font-bold text-red-600"><?php echo e($stockSummary['out_of_stock']); ?></div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-2xl font-bold text-blue-600"><?php echo e($products->count()); ?></div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-12 w-12">
                                    <img class="h-12 w-12 rounded-xl object-cover" src="<?php echo e(asset('storage/' . $product->image_url)); ?>" alt="<?php echo e($product->name); ?>">
                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($product->name); ?></div>
                                    <div class="text-sm text-gray-500">ID: <?php echo e($product->id); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <form action="<?php echo e(route('admin.products.update-stock', $product->id)); ?>" method="POST" class="flex items-center space-x-2">
                                <?php echo csrf_field(); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            <button onclick="openQuickUpdateModal(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>', <?php echo e($product->stock); ?>)"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DOKUMEN\BNSP\example-app\resources\views/admin/products/stock.blade.php ENDPATH**/ ?>