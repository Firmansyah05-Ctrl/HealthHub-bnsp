...
<?php $__env->startSection('title', 'Permohonan Toko - Admin HealthHub'); ?>
<?php $__env->startSection('description', 'Kelola permohonan pembuatan toko baru di HealthHub.'); ?>
...
<div class="max-w-7xl mx-auto">
            ...
            <div class="hidden md:block">
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center">
                        <div class="text-2xl font-bold"><?php echo e($statistics['total_requests']); ?></div>
                        <div class="text-rose-200 text-sm">Total Permohonan</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold"><?php echo e($statistics['approval_rate']); ?>%</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-gradient-to-br from-yellow-50 to-amber-100 rounded-2xl p-6 border border-yellow-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-yellow-700"><?php echo e($statistics['pending_requests']); ?></div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl p-6 border border-green-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-green-700"><?php echo e($statistics['approved_requests']); ?></div>
        ...
        <div class="bg-gradient-to-br from-red-50 to-rose-100 rounded-2xl p-6 border border-red-200">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-red-700"><?php echo e($statistics['rejected_requests']); ?></div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <form method="GET" action="<?php echo e(route('admin.shop_requests.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <!-- Search -->
                        ...
                        <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($requests->firstItem() + $index); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-gradient-to-br from-rose-400 to-pink-500 rounded-full flex items-center justify-center text-white font-semibold mr-3">
                                            <?php echo e(substr($req->user->name ?? 'U', 0, 2)); ?>

                                        </div>
                                        <div>
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($req->user->name ?? 'User tidak ditemukan'); ?></div>
                                            <div class="text-sm text-gray-500"><?php echo e($req->user->email ?? '-'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900"><?php echo e($req->shop_name); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php
                                    ...
                                    ?>
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium text-white <?php echo e($statusClass); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <div class="text-xs"><?php echo e($req->created_at->format('H:i')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php if($req->processed_at): ?>
                                        <?php echo e($req->processed_at->format('d M Y')); ?>

                                        <div class="text-xs">oleh <?php echo e($req->processedBy->name ?? 'System'); ?></div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <?php if($req->status === 'pending'): ?>
                                        <div class="flex space-x-2">
                                            <form action="<?php echo e(route('admin.shop_requests.approve', $req->id)); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" 
                                            ...
                                            <form action="<?php echo e(route('admin.shop_requests.reject', $req->id)); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DOKUMEN\BNSP\example-app\resources\views/admin/shop_requests/index.blade.php ENDPATH**/ ?>